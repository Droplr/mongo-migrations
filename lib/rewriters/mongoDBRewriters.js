...
const methodNameLogHelper = methodTrail => `${methodTrail} ran with`;
...
const prepareReturn = callback => typeof callback === 'function' ? callback() : Promise.resolve();
...
Object.assign(
  Db.prototype,
  {
    createCollection: function (name, options, callback) {
      logger.info(
        methodNameLogHelper(`${this.s.databaseName}.createCollection()`),
...
Object.assign(
  Collection.prototype,
  {
    find: function (query, options, callback) {
      logger.info(
        methodNameLogHelper(`${this.s.namespace}.find()`),
        optionsLogHelper(options),
        'search for',
        query
      );
    ...
    findOne: function (query, options, callback) {
      logger.info(
        methodNameLogHelper(`${this.s.namespace}.findOne()`),
        optionsLogHelper(options),
        'search for',
        query
      );
    ...
    createIndex: function (fieldOrSpec, options, callback) {
      logger.info(
        methodNameLogHelper(`${this.s.namespace}.createIndex()`),
    ...
    updateOne: function (filter, update, options, callback) {
      logger.info(
        methodNameLogHelper(`${this.s.namespace}.updateOne()`),
        'update query',
    ...
    updateMany: function (filter, update, options, callback) {
      if (typeof callback === 'function') {
        return originalCountDocuments.call(this, filter, undefined, (err, objectsCount) => {
          ...
          logger.info(
            methodNameLogHelper(`${this.s.namespace}.updateMany()`),
    ...
    drop: function (options, callback) {
      logger.info(
        methodNameLogHelper(`${this.s.namespace}.drop()`),
        optionsLogHelper(options),
        this.s.namespace,
    ...
    insertOne: function (doc, options, callback) {
      logger.info(
        methodNameLogHelper(`${this.s.namespace}.insertOne()`),
        optionsLogHelper(options),
        JSON.stringify(doc),
    ...
    deleteOne: function (filter, options, callback) {
      logger.info(
        methodNameLogHelper(`${this.s.namespace}.deleteOne()`),
        optionsLogHelper(options),
