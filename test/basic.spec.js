...
describe('migration set', () => {
  ...
  it('should handle basic migration', async () => {
    await set.up();
    assertPets();
    await set.up();
    assertPets();
  ...
  it('should add a new migration', async () => {
    set.addMigration('add dogs', async () => {
  ...
  it('should emit events', async () => {
    set.addMigration('4-adjust-emails.js', async () => {
      db.pets.forEach((pet) => {
  ...
  it('should migrate to named migration', async () => {
    assertNoPets();
  ...
  it('should load migration descriptions', () => {
